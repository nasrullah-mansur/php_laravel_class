                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-area">
                                                            <a href="{{ route('role.edit', $role->id) }}" type="submit" class="btn btn-raised btn-primary waves-effect">Edit</a>
                                                            <a href="#" type="submit" class="btn btn-raised btn-danger waves-effect delete-btn">Delete</a>
                                                            <form class="d-none" action="{{ route('role.delete') }}" method="POST">
                                                                @csrf
                                                                <input type="test" name="id" value="{{ $role->id }}">
                                                            </form>
                                                        </div>
                                                    </td>
                                                </tr>
