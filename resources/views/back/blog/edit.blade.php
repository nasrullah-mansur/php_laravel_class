...
<section class="content">
    <div class="body_scroll">
        ...
        <div class="container-fluid" style="min-height: calc(100vh - 150px);">
            <form method="POST" action="{{ route('back.blog.update', $blog->slug) }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="body">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <input value="{{ old('title') ? old('title') : $blog->title }}" name="title" type="text" id="title" class="form-control" placeholder="SEO Title" />
